    ...
    (function(f2) {
      ...
      return function() {
        ...
        const dateTime = function() {
          ...
          const getDateTimeFragment = (date, component2) => {
            let componentValue;
            switch (component2) {
              case "Y":
  ...
  "../../node_modules/rete/build/rete.common.js"(exports) {
    ...
    var Context = /* @__PURE__ */ function(_Emitter) {
      ...
      _createClass(Context2, [{
        ...
        key: "register",
        value: function register(component2) {
          if (this.components.has(component2.name))
            throw new Error("Component ".concat(component2.name, " already registered"));
          this.components.set(component2.name, component2);
          this.trigger("componentregister", component2);
        }
      }, {
        key: "destroy",
    ...
    var NodeView = /* @__PURE__ */ function(_Emitter) {
      ...
      function NodeView2(node, component2, emitter) {
        var _this;
    ...
    var EditorView = /* @__PURE__ */ function(_Emitter) {
      ...
      _createClass(EditorView2, [{
        ...
        value: function addNode(node) {
          var component2 = this.components.get(node.name);
          if (!component2)
            throw new Error("Component ".concat(node.name, " not found"));
          var nodeView = new NodeView(node, component2, this);
    ...
    var NodeEditor = /* @__PURE__ */ function(_Context) {
      ...
      _createClass(NodeEditor2, [{
        ...
        value: function getComponent(name) {
          var component2 = this.components.get(name);
          if (!component2)
        ...
        key: "register",
        value: function register(component2) {
          _get(_getPrototypeOf(NodeEditor2.prototype), "register", this).call(this, component2);
          component2.editor = this;
        }
      }, {
        key: "clear",
        value: function clear() {
                        ...
                        return _regeneratorRuntime().wrap(function _callee$(_context) {
                          while (1) {
                            switch (_context.prev = _context.next) {
                              case 0:
                                node = json.nodes[id];
                                component2 = _this4.getComponent(node.name);
                                _context.next = 4;
                                return component2.build(Node2.fromJSON(node));
                              case 4:
      ...
      _createClass(Engine2, [{
        ...
        value: function() {
          var _processWorker = _asyncToGenerator(/* @__PURE__ */ _regeneratorRuntime().mark(function _callee6(node) {
            var inputData, component2, outputData;
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  ...
                  case 2:
                    ...
                    component2 = this.components.get(node.name);
                    outputData = {};
                    _context6.prev = 5;
                    _context6.next = 8;
                    return component2.worker.apply(component2, [node, inputData, outputData].concat(_toConsumableArray(this.args)));
                  case 8:
                    _context6.next = 14;
                    break;
                  case 10:
...
component.addInput(
  ...
  component.createInput("page", "integer").set("description", "The review page number to retrieve. Defaults to 1, maximum allowed is 10.").setDefault(1).toOmniIO()
).addInput(
  component.createInput("sort", "string").set("description", "The review sort order.").setDefault("mostRecent").setChoices(["mostRecent", "mostHelpful"], "mostRecent").toOmniIO()
).addOutput(
  component.createOutput("data", "array").set("description", "The reviews data").toOmniIO()
).setMacro(OmniComponentMacroTypes.EXEC, async (payload, ctx) => {
